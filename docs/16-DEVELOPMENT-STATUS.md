...
> قابلیت‌های درخواست‌شده — **اولویت فعلی توسعه** (فاز ۹ موکول). با شروع پیاده‌سازی، وضعیت را به‌روز کنید.
...
| FL-06 | آرشیو گفتگوها | آرشیو کردن مکالمات (خارج از inbox فعال)، بازیابی و فیلتر archived | Inbox | انجام شد | metadata.archivedAt؛ تب آرشیو |
| FL-07 | گزارش گفتگوها | گزارش بر اساس بازه تاریخ، export، جستجو در متن/فیلترها | گزارش | برنامه‌ریزی | P5+ |
| FL-08 | تعداد بازدیدکننده آنلاین | نمایش live تعداد مشتری/بازدیدکننده آنلاین در داشبورد | ریل‌تایم | انجام شد | Redis presence + inbox |
| FL-09 | تعداد اپراتور آنلاین | نمایش live تعداد اپراتورهای آنلاین (presence) | ریل‌تایم | انجام شد | Redis presence + inbox |
