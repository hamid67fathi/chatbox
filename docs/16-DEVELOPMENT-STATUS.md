...
| کد | عنوان | توضیح | وضعیت | تاریخ | یادداشت |
|----|-------|-------|--------|-------|---------|
| FL-05 | ابزارک (ویجت + پلاگین) | ویجت embed + پلاگین CMS (وردپرس و …) با برند «ابزارک» | شروع نشده | — | ویجت embed موجود؛ **تبلیغ ChatBox پایین چت** برای workspace بدون اشتراک پرداخت‌شده (`show_branding`) |
